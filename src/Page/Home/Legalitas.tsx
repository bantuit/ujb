...
const Legalitas = () => {
    return (
        <div className='w-full h-fit bg-[#F3F1F1] flex flex-col lg:flex-row flex-wrap px-20 py-20 space-y-5'>
            ...
            <div className='h-full w-full lg:w-1/2 flex flex-wrap justify-center items-center gap-x-5  '>
                <img className='w-36 h-52' src={Iso4} alt="" />
                <img className='w-auto h-36' src={Iso3} alt="" />
                <img className='w-40 h-36' src={Iso1} alt="" />
                <img className='w-36 h-48' src={Iso2} alt="" />
                <img className='w-36 h-48' src={bkpm} alt="" />
            </div>
        </div>
    )
}
