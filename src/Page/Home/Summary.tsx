...
const Summary = () => {
  return (
    <div className="h-[90vh] w-full flex justify-center items-center py-5 md:py-16">
      <div className="w-full min-h-fit h-full lg:h-full flex flex-row md:flex-row flex-wrap gap-5 justify-center items-center  ">
        <img className="w-1/2 h1/5 md:h-1/2 md:w-1/5" src={logo} alt="" />
        <div className="flex flex-col px-5 md:px-10 md:py-3 w-full md:w-[60vw] space-y-2">
