...
const LowonganKerja = () => {
  ...
  return (
    <div className='h-screen mb-20 flex flex-col justify-start pt-10 items-center gap-10 py-44 '>
            ...
            <div key={index} className="card w-80 bg-base-100 shadow-xl">
              <div className="card-body flex items-center ">
                ...
                <div className="card-actions justify-end mt-10">
                  <button className="btn btn-outline btn-info" onClick={() => navigaet(`/karir/lamar-kerja/${item.posisi}`)}>Lamar Sekarang <IoIosArrowRoundForward /></button>
                </div>
              </div>
            </div>
          )
